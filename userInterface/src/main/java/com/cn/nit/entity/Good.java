...
public class Good implements java.io.Serializable {
    ...
    public Good(Integer userId, String goodName, Date createDate, Date modifyDate, String goodIntroduction, double price, Integer isOrdered) {
        super();
        this.userId = userId;
    ...
    public String toString() {
        return "Good [goodId=" + goodId + ", userId=" + userId + ", goodName=" + goodName + ", createDate=" + createDate + ", modefyDate=" + modifyDate + ", goodIntroduction=" + goodIntroduction
                + ", price=" + price + "]";
    }
